...
const collectionName = '/api/inverterList'; // Replace with your Collection Name

const getData = async (req, res) => {
  try {
    // Parse the raw JSON body directly
    ...
    const expectedMD5 = crypto.createHash('md5').update(JSON.stringify(rawData)).digest('base64');
